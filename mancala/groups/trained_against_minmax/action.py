...
model = 5 * [None]
loadtrainstep = 2999
model[0] = torch.load('mancala/groups/trained_against_minmax/ac/b1_trained_'+str(loadtrainstep)+'.pth')
model[1] = torch.load('mancala/groups/trained_against_minmax/ac/w1_trained_'+str(loadtrainstep)+'.pth')
model[2] = torch.load('mancala/groups/trained_against_minmax/ac/b2_trained_'+str(loadtrainstep)+'.pth')
model[3] = torch.load('mancala/groups/trained_against_minmax/ac/w2_trained_'+str(loadtrainstep)+'.pth')
model[4] = torch.load('mancala/groups/trained_against_minmax/ac/theta_'+str(loadtrainstep)+'.pth')
