...
model = 5 * [None]
loadtrainstep = 625
model[0] = torch.load('mancala/groups/actor_critic_basic/ac/b1_trained_'+str(loadtrainstep)+'.pth')
model[1] = torch.load('mancala/groups/actor_critic_basic/ac/w1_trained_'+str(loadtrainstep)+'.pth')
model[2] = torch.load('mancala/groups/actor_critic_basic/ac/b2_trained_'+str(loadtrainstep)+'.pth')
model[3] = torch.load('mancala/groups/actor_critic_basic/ac/w2_trained_'+str(loadtrainstep)+'.pth')
model[4] = torch.load('mancala/groups/actor_critic_basic/ac/theta_'+str(loadtrainstep)+'.pth')
